    ...
    <div class="container">
        ...
        <form method="GET" action="{{ route('berita.search') }}" class="mb-4">
            <div class="input-group">
                <input type="text" name="query" class="form-control" placeholder="Cari berita berdasarkan judul" value="{{ request('query') }}">
        ...
        <div class="row mb-4">
            ...
            <div class="col-lg-3">
                <div class="cardStyle">
                    ...
                    <img
                        class="imgStyle"
                        src="{{ asset('storage/' . $data->ber_foto1) }}" />

                    <div class="textContainerStyle">
                        <div class="textContentStyle">
                            <h6 style="size: 18px; color:black; font-weight:700; text-align:left; margin: 20px 0px 10px 0px">
                                {{$data->ber_judul}}
                            </h6>
                ...
                margin-bottom: 10px;
              ">
                                Oleh {{$data->ber_penulis}} | {{ \Carbon\Carbon::parse($data->ber_tgl)->locale('id')->translatedFormat('l, d F Y') }}
                            </p>
