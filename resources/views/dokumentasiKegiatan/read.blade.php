...
<div class="d-flex flex-column min-vh-100 p-5 pt-0">
    <div class="ms-5 ps-3">
        <div style="display: flex; align-items: center; ">
            <span style="color: #2654A1; font-size: 5rem; margin-right: 10px; cursor: pointer;" onclick="window.location.href='/kegiatan/dokumentasi'">&#x2039;</span>
            <h2 style="color: #2654A1; margin: 0; padding-top:1rem;">Kelola Dokumentasi Kegiatan</h2>
        </div>
    </div>

    <div class="ms-5 ps-5">
        <a class="btn btn-primary" href="{{ route('dokumentasiKegiatan.add') }}">Tambah Dokumentasi Kegiatan</a>
    </div>

    <div class="ms-5 p-5 pt-0 pb-0 my-3">
        <form action="{{ route('dokumentasiKegiatan.search') }}" method="GET" class="d-flex">
    ...
    <div class="table-container bg-white p-3 ps-5 m-5 mt-0 rounded">
        <table class="table table-hover table-striped table-bordered">
            ...
            <tbody>
                @php $i = 1 + (($kegiatan->currentPage() - 1) * 3); @endphp
                ...
                <tr class="align-middle">
                    ...
                    <td style="width: 200px;">
                        <form style="text-align: center;"
                            ...
                            action="{{ route('dokumentasiKegiatan.delete', $data->keg_id) }}"
                            method="POST"
                            onsubmit="return confirmDelete(event, {{ $data->keg_id }});">


                            <a href="{{ route('dokumentasiKegiatan.show', $data->keg_id) }}" class="btn btn-success btn-sm me-1">
                                <i class="mdi mdi-eye"></i>
                            </a>
                            <a href="{{ route('dokumentasiKegiatan.edit', $data->keg_id) }}" class="btn btn-primary btn-sm me-1">
