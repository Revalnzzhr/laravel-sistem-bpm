...
<div class="d-flex flex-column min-vh-100 p-5 pt-0">
    ...
    <div class="shadow p-5 m-5 mt-3 bg-white rounded">
        ...
        <form method="POST" action="{{ route('jadwalKegiatan.store') }}" enctype="multipart/form-data">
            @csrf

            <div class="form-group mb-3">
                <label for="keg_nama" class="form-label fw-bold">Nama Kegiatan</label>
                <input type="text" name="keg_nama" id="keg_nama" class="form-control" value="{{ old('keg_nama') }}" required>
                @error('keg_nama')
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group mb-3">
                        ...
                        <select name="jkg_id" id="jkg_id" class="form-control" required>
                            ...
                            <option value="{{ $jenis->jkg_id }}" {{ old('jkg_id') == $jenis->jkg_id ? 'selected' : '' }}>
                                {{ $jenis->jkg_nama }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="date" name="keg_tgl_mulai" id="keg_tgl_mulai" class="form-control" value="{{ old('keg_tgl_mulai') }}" required>
                        @error('keg_tgl_mulai')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="form-group mb-3">
                        ...
                        <input type="time" name="keg_jam_mulai" id="keg_jam_mulai" class="form-control" value="{{ old('keg_jam_mulai') }}" required>
                        @error('keg_jam_mulai')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="keg_tempat" id="keg_tempat" class="form-control" value="{{ old('keg_tempat') }}" required>
                        @error('keg_tempat')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="form-group mb-3">
                        ...
                        <input type="date" name="keg_tgl_selesai" id="keg_tgl_selesai" class="form-control" value="{{ old('keg_tgl_selesai') }}" required>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="time" name="keg_jam_selesai" id="keg_jam_selesai" class="form-control" value="{{ old('keg_jam_selesai') }}" required>
            ...
            <div class="form-group mb-3">
                ...
                <textarea name="keg_deskripsi" id="keg_deskripsi" class="form-control" rows="5" required>{{ old('keg_deskripsi') }}</textarea>
                @error('keg_deskripsi')
                <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
